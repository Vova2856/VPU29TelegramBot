...
STATE_FIRST_NAME, STATE_LAST_NAME, STATE_PHONE_NUMBER, STATE_GMAIL_EMAIL = range(4)
...
class UserRegisterConversationHandler(BaseHandler):
    ...
    def register(cls, app):
        conversation_handler = ConversationHandler(
            ...
            states={
                ...
                STATE_GMAIL_EMAIL: [MessageHandler(filters.TEXT & ~filters.COMMAND, cls.gmail_email)],
            },
    ...
    async def phone_number(cls, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        @classmethod
        async def gmail_email(update: Update, context):
