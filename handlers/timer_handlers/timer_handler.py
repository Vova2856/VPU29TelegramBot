...
class TimerHandler(BaseHandler):
    ...
    async def set_timer(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            job_removed = TimerHandler.remove_job_if_exists(str(chat_id), context)
            context.job_queue.run_once(TimerHandler.alarm, due, chat_id=chat_id, name=str(chat_id), data=due)
